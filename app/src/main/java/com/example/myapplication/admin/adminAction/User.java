...
import com.example.myapplication.admin.adminAction.user.UserPack.ViewHolderUserData;
...
public class User extends Fragment {
    ...
    private void showIt(List<UserAndServiceProviderPojo> body) {
        ...
        CustomUserAdapter customUserAdapter = new CustomUserAdapter(body, getContext());
